...
class MembersApi
{
     ...
     * @return \iBooking\Client\Model\MembersResponse
     */
     ...
     * @throws \iBooking\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \iBooking\Client\Model\MembersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMembersWithHttpInfo()
    {
        $returnType = '\iBooking\Client\Model\MembersResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\iBooking\Client\Model\MembersResponse',
    ...
    /**
     * Operation userGetBookingsGet
     *
     * This method returns a list of the bookings for a user. Sorted descending by class.from.
     *
     * @param  string $token The user&#x27;s token (required)
     * @param  int $limit How many bookings to return. Default: 60 (optional)
     * @param  string $sort Default: desc (optional)
     *
     * @throws \iBooking\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \iBooking\Client\Model\GetUserBookingsResponse
     */
    public function userGetBookingsGet($token, $limit = null, $sort = null)
    {
        list($response) = $this->userGetBookingsGetWithHttpInfo($token, $limit, $sort);
        return $response;
    }

    /**
     * Operation userGetBookingsGetWithHttpInfo
     *
     * This method returns a list of the bookings for a user. Sorted descending by class.from.
     *
     * @param  string $token The user&#x27;s token (required)
     ...
     * @throws \iBooking\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \iBooking\Client\Model\GetUserBookingsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function userGetBookingsGetWithHttpInfo($token, $limit = null, $sort = null)
    {
        $returnType = '\iBooking\Client\Model\GetUserBookingsResponse';
        $request = $this->userGetBookingsGetRequest($token, $limit, $sort);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\iBooking\Client\Model\GetUserBookingsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation userGetBookingsGetAsync
     *
     * This method returns a list of the bookings for a user. Sorted descending by class.from.
     *
     * @param  string $token The user&#x27;s token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetBookingsGetAsync($token, $limit = null, $sort = null)
    {
        return $this->userGetBookingsGetAsyncWithHttpInfo($token, $limit, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation userGetBookingsGetAsyncWithHttpInfo
     *
     * This method returns a list of the bookings for a user. Sorted descending by class.from.
     *
     * @param  string $token The user&#x27;s token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function userGetBookingsGetAsyncWithHttpInfo($token, $limit = null, $sort = null)
    {
        $returnType = '\iBooking\Client\Model\GetUserBookingsResponse';
        $request = $this->userGetBookingsGetRequest($token, $limit, $sort);
    ...
    /**
     * Create request for operation 'userGetBookingsGet'
     *
     * @param  string $token The user&#x27;s token (required)
     * @param  int $limit How many bookings to return. Default: 60 (optional)
     * @param  string $sort Default: desc (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function userGetBookingsGetRequest($token, $limit = null, $sort = null)
    {
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling userGetBookingsGet'
            );
        }

        $resourcePath = '/User/getBookings';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
