...
class GymsApi
{
     ...
     * @return \iBooking\Client\Model\GymsResponse
     */
     ...
     * @throws \iBooking\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \iBooking\Client\Model\GymsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGymsWithHttpInfo()
    {
        $returnType = '\iBooking\Client\Model\GymsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\iBooking\Client\Model\GymsResponse',
